...
export const HomeContainer = () => {
  ...
  <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full' id='home'>
    <div className='py-2 flex-1 flex flex-col items-start justify-center gap-6'>
      <div className='flex items-center gap-2 justify-center bg-orange-100 px-4 py-1 rounded-full'>
       ...
       <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat, mollitia! Odit at porro hic temporibus aut sint voluptatibus eaque unde.
        </p>
    ...
    <div className='py-2 flex-1 flex items-center relative'>
           <img src={HeroBg} className="ml-auto h-400 lg:w-auto lg:h-600" alt="hero-bg"  />
      <div className='w-full h-full absolute top-0 left-0  py-4 flex items-center justify-center  gap-10 flex-wrap'>
       ...
       {heroData && heroData.map(n =>(
         ...
         <p className='text-base lg:text-xl mt-2 lg:mt-3 font-semibold text-textColor' >{n.name}</p>
